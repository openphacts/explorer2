App.SearchController = Ember.ArrayController.extend({
    ...
    actions: {
        ...
        setCompoundsChecked: function() {
            this.get('compoundsChecked') === true ? this.set('compoundsChecked', false) : this.set('compoundsChecked', true);
        },
        setTargetsChecked: function() {
            this.get('targetsChecked') === true ? this.set('targetsChecked', false) : this.set('targetsChecked', true);
        }
