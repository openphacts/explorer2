App.PathwaysTargetsController = Ember.Controller.extend({
    ...
    actions: {
        ...
        sortHeader: function(header) {
            ...
            if (this.get('currentHeader') === header && this.get('sortedHeader') === header) {
                this.get('targets').set('sortProperties', sortHeader);
                this.get('targets').set('sortAscending', false);
                //descending
                ...
                this.get('targets').set('sortProperties', sortHeader);
                this.get('targets').set('sortAscending', true);
