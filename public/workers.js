...
onmessage = function(e) {
    ...
    if (requestType === "compound") {
        ...
        if (treeType === "tree") {
            ...
            searcher.getTargetClassPharmacologyPaginated(params.uri, params.assay_organism, params.target_organism, params.activity_type, params.activity_value_type === "activity_value" ? params.activity_value : null, params.activity_unit, params.activity_value_type === "min-activity_value" ? params.activity_value : null, params.activity_value_type === "minEx-activity_value" ? params.activity_value : null, params.activity_value_type === "max-activity_value" ? params.activity_value : null, params.activity_value_type === "maxEx-activity_value" ? params.activity_value : null, params.activity_relation, params.pchembl_value_type === "pchembl" ? params.pchembl_value : null, params.pchembl_value_type === "min-pChembl" ? params.pchembl_value : null, params.pchembl_value_type === "minEx-pChembl" ? params.pchembl_value : null, params.pchembl_value_type === "max-pChembl" ? params.pchembl_value : null, params.pchembl_value_type === "maxEx-pChembl" ? params.pchembl_value : null, null, null, i, 250, null, treeCallback);
        } else {
            headers = {
                'inchiKey': 'InChiKey',
                'targetTitle': 'Target title',
