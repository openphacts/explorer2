module Searcher
  class CompoundSearcher
    ...
    def parse_compound json
      ...
      em.each do |match|
        src = match[CompoundSearcher::LDA_IN_DATASET]
        if (CompoundSearcher::LDA_SRC_CLS_MAPPINGS[src] == 'chemspiderValue')
          chemspiderValue = match
        elsif (CompoundSearcher::LDA_SRC_CLS_MAPPINGS[src] == 'drugbankValue')
          drugBankData = match
        elsif (CompoundSearcher::LDA_SRC_CLS_MAPPINGS[src] == 'chemblValue')
          chemblValue = match
        end
      end
      conceptWikiUri = pt["_about"]
      chemspiderValue != nil ? chemSpiderUri = chemspiderValue[CompoundSearcher::LDA_ABOUT] : chemSpiderUri = nil
      chemblValue != nil ? chemblUri = chemblValue[CompoundSearcher::LDA_ABOUT] : chemblUri = nil
      drugBankData != nil ? drugbankUrl = drugBankData[CompoundSearcher::LDA_ABOUT] : drugbankUrl = nil
      ...
      compound = Compound.new(:cw_uri =>pt[CompoundSearcher::LDA_ABOUT],
            ...
            :inchi_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :inchi_item => chemspiderLinkOut,
            :inchi_key => chemspiderValue != nil ? chemspiderValue['inchikey'] : nil,
            :inchi_key_item => chemspiderLinkOut,
            :inchi_key_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :compound_smiles => chemspiderValue != nil ? chemspiderValue['smiles'] : nil,
            :compound_smiles_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :compound_smiles_item => chemspiderLinkOut,
            :alogp => chemspiderValue != nil ? chemspiderValue['logp'] : nil,
            :alogp_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :alogp_item => chemspiderLinkOut,
            :full_mwt => chemblValue != nil ? chemblValue['full_mwt'] : nil,
            :full_mwt_src => chemblValue != nil ? chemblValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :full_mwt_item => chemblLinkOut,
            :hba => chemspiderValue != nil ? chemspiderValue['hba'] : nil,
            :hba_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :hba_item => chemspiderLinkOut,
            :hbd => chemspiderValue != nil ? chemspiderValue['hbd'] : nil,
            :hbd_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :hbd_item => chemspiderLinkOut,
            :molform => chemblValue != nil ? chemblValue['molform'] : nil,
            :molform_src => chemblValue != nil ? chemblValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :molform_item => chemblLinkOut,
            :mw_freebase => chemblValue != nil ? chemblValue['mw_freebase'] : nil,
            :mw_freebase_src => chemblValue != nil ? chemblValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :mw_freebase_item => chemblLinkOut,
            :psa => chemspiderValue != nil ? chemspiderValue['psa'] : nil,
            :psa_src => chemspiderValue != nil ? chemspiderValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :psa_item => chemspiderLinkOut,
            :rtb => chemblValue != nil ? chemblValue['rtb'] : nil,
            :rtb_src => chemblValue != nil ? chemblValue[CompoundSearcher::LDA_IN_DATASET] : nil,
            :rtb_item => chemblLinkOut,
            :biotransformation => drugBankData != nil ? drugBankData['biotransformation'] : nil,
            :biotransformation_src => drugBankData != nil ? drugBankData[CompoundSearcher::LDA_IN_DATASET] : nil,
            :biotransformation_item => drugbankLinkOut,
            :description => drugBankData != nil ? drugBankData['description'] : nil,
            :description_src => drugBankData != nil ? drugBankData[CompoundSearcher::LDA_IN_DATASET] : nil,
            :description_item => drugbankLinkOut,
            :proteinBinding => drugBankData != nil ? drugBankData['proteinBinding'] : nil,
            :proteinBinding_src => drugBankData != nil ? drugBankData[CompoundSearcher::LDA_IN_DATASET] : nil,
            :proteinBinding_item => drugbankLinkOut,
            :toxicity => drugBankData != nil ? drugBankData['toxicity'] : nil,
            :toxicity_src => drugBankData != nil ? drugBankData[CompoundSearcher::LDA_IN_DATASET] : nil,
            :toxicity_item => drugbankLinkOut,
            :compound_pref_label => pt['prefLabel'],
            :compound_pref_label_src => pt[CompoundSearcher::LDA_IN_DATASET],
            :compound_pref_label_item => conceptWikiUri,
            :meltingPoint => drugBankData != nil ? drugBankData['meltingPoint'] : nil,
            :meltingPoint_src => drugBankData != nil ? drugBankData[CompoundSearcher::LDA_IN_DATASET] : nil,
