module Searcher
  ...
  class Compound
    ...
    attr_accessor :cw_uri, :cs_uri, :chembl_uri, :drugbank_uri, :inchi, :inchi_src, :inchi_item, :inchi_key, :inchi_key_item, :inchi_key_src,
                  :compound_smiles, :compound_smiles_src, :compound_smiles_item, :alogp, :alogp_src, :alogp_item, :full_mwt, :full_mwt_src,
                  ...
                  :biotransformation_src, :biotransformation_item, :description, :description_src, :description_item, :proteinBinding,
                  :proteinBinding_src, :proteinBinding_item, :toxicity, :toxicity_src, :toxicity_item, :compound_pref_label,
